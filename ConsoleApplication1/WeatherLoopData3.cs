...
namespace ConsoleApplication1
{
    class WeatherLoopData3
    {
        ...
        public void Load(byte[] loopArray3)
        {
            ...
            */
            voltage = (float)BitConverter.ToInt16(loopArray3, 87) * 300 / 512 / 100; //Тока на конзолата
            ...
            // more easily.
            timeString = BitConverter.ToInt16(loopArray3, 91).ToString();    // Uint16
            ...
            timeString = BitConverter.ToInt16(loopArray3, 93).ToString();    // Uint16
            hours = Convert.ToInt32(timeString.Substring(0, timeString.Length - 2));
            minutes = Convert.ToInt32(timeString.Substring(timeString.Length - 2, 2));
        ...
        public string DebugString()
        {
            ...
            */
            File.AppendAllText(@"D:\Davis\Chirpan.txt", "Station - 42027, Date: " + DateTime.Now + ", Voltage: " + Convert.ToString(voltage) + " V" + Environment.NewLine);
