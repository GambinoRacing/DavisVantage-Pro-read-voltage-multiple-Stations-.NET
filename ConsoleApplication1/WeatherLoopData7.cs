...
namespace ConsoleApplication1
{
    class WeatherLoopData7
    {
        ...
        public void Load(byte[] loopArray7)
        {
            ...
            */
            voltage = (float)BitConverter.ToInt16(loopArray7, 87) * 300 / 512 / 100; //Тока на конзолата
            ...
            // more easily.
            timeString = BitConverter.ToInt16(loopArray7, 91).ToString();    // Uint16
            ...
            timeString = BitConverter.ToInt16(loopArray7, 93).ToString();    // Uint16
            hours = Convert.ToInt32(timeString.Substring(0, timeString.Length - 2));
            minutes = Convert.ToInt32(timeString.Substring(timeString.Length - 2, 2));
        ...
        public string DebugString()
        {
             ...
             */
            File.AppendAllText(@"D:\Davis\Koprivshtitsa.txt", "Station - 64127, Date: " + DateTime.Now + ", Voltage: " + Convert.ToString(voltage) + " V" + Environment.NewLine);
