...
namespace ConsoleApplication1
{
    ...
    public class WeatherLoopData1
    {
        ...
        public void Load(byte[] loopArray1)
        {
             ...
             */
            voltage = (float)BitConverter.ToInt16(loopArray1, 87) * 300 / 512 / 100; //Тока на конзолата
            ...
            // more easily.
            timeString = BitConverter.ToInt16(loopArray1, 91).ToString();    // Uint16
            ...
            timeString = BitConverter.ToInt16(loopArray1, 93).ToString();    // Uint16
            hours = Convert.ToInt32(timeString.Substring(0, timeString.Length - 2));
            minutes = Convert.ToInt32(timeString.Substring(timeString.Length - 2, 2));
        ...
        public string DebugString()
        {
            ...
            */
            File.AppendAllText(@"D:\Davis\Barutin.txt", "Station - 45487, Date: " + DateTime.Now + ", Voltage: " + Convert.ToString(voltage) + " V" + Environment.NewLine);
