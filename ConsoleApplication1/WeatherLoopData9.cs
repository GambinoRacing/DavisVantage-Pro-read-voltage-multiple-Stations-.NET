...
namespace ConsoleApplication1
{
    class WeatherLoopData9
    {
        ...
        public void Load(byte[] loopArray9)
        {
            ...
            */
            voltage = (float)BitConverter.ToInt16(loopArray9, 87) * 300 / 512 / 100; //Тока на конзолата
            ...
            // more easily.
            timeString = BitConverter.ToInt16(loopArray9, 91).ToString();    // Uint16
            ...
            timeString = BitConverter.ToInt16(loopArray9, 93).ToString();    // Uint16
            hours = Convert.ToInt32(timeString.Substring(0, timeString.Length - 2));
            minutes = Convert.ToInt32(timeString.Substring(timeString.Length - 2, 2));
        ...
        public string DebugString()
        {
            ...
            */
            File.AppendAllText(@"D:\Davis\Sadievo.txt", "Station - 41037, Date: " + DateTime.Now + ", Voltage: " + Convert.ToString(voltage) + " V" + Environment.NewLine);
